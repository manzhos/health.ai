...
PartnerListToolbar.propTypes = {
  numSelected: PropTypes.number,
};

export default function PartnerListToolbar({ numSelected, onFilterName, onPartnerRole }) {
    ...
    >
      {numSelected > 0 ? (
        ...
        <>
          ...
          {/* <PartnerRole uRole={partnerRole} onChangePartnerRole={handleChangePartnerRole} /> */}
