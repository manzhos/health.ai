...
export default function CommunicationByTicket({ticket, message, procedure, client}) {
          ...
          <div className="login-modal">
            ...
            >
              <Typography component="h1" variant="h5">
                Reply to the ticket #{ticket}
              </Typography>
              <ReplyTicket ticket={ticket} message={message} procedure={procedure} client={client} />
            </Box>
          </div>
        </Container>
      </Modal>
      ...
      >
        <Container component="main" maxWidth="md" disableGutters>
          <div className="login-modal">
            ...
            >
              <Typography component="h1" variant="h5">
                Communication by ticket #{ticket}
              </Typography>
              <InboxTicket ticket={ticket} client={client} />
            </Box>
          </div>
        </Container>
      </Modal>
