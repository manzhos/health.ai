                    ...
                    >
                      ...
                      <TableCell align="left">
                        {/* {invoice.map((item, key)=>{
                          let inf = '';
                          if(Object.keys(item).length && Object.keys(item).length > 0){
                            for(let k in item){
                              inf += `
                                <div style="width: 100%" key={key*10 + k}>
                                  <div>{k} : {item[k]}</div>
                                </div>`
                            }
                          } else {
                        ...
                        <div>
                          ...
                          <div sx={{width: "100%"}}>
                            Number Units : <strong>5</strong>
                          </div>
                          <div sx={{width: "100%"}}>
                            Zone : 3
                          </div>
                          <div sx={{width: "100%"}}>
                            Number Units : <strong>4</strong>
                          </div>
                          <div sx={{width: "100%"}}>
                            Cost : <strong>299</strong> EUR
                          </div>
                        </div>
                      </TableCell>
